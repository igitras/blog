package com.igitras.oauth.config;

import com.igitras.oauth.service.CustomUserDetailsService;
...
public class AuthServerConfiguration {
    private static final String AUTH_SERVER_RESOURCE_ID = "igitras-auth-server";
    private static final String RESOURCE_SERVER_RESOURCE_ID = "igitras-resource-server";
